...
export const PANEL_DEFAULTS = {
    ...
    panelW: 240,    // a row spills to the next row past this width (a panel's tangential bound)
    panelH: 300,    // a panel spills to the next panel past this stacked height
    colGap: 24,     // HStack gap between grids within a row
    rowGap: 24,     // VStack gap between rows within a panel
};
