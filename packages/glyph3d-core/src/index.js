...
export { extOf, mimeForFormat, classifyByExtension, sniffMagic, isProbablyUtf8, classifyBytes, partitionDirEntries, languageOf, tintForPath, LANG_TINTS } from './core/fileKind.js';
...
export { HarfBuzzShaper, MonospaceShapeCache, shapeText, collectUniqueGlyphIds, SlugEncoder, SlugBuffer, encodeGlyph } from './shaping/index.js';
