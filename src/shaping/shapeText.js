/**
 * shapeText - Line-by-line text shaping using HarfBuzzShaper.
 *
 ...
 * @param {string} [features] - Comma-separated OpenType features
 * @returns {{
 *   lines: Array<{
 *     shaped: Array<{g: number, cl: number, ax: number, ay: number, dx: number, dy: number}>,
 *     text: string
 *   }>,
 *   totalGlyphs: number
 * }}
 */
export function shapeText(shaper, text, features) {
